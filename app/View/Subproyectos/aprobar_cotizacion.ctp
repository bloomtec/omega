...
<?php echo $this -> Form->create("Subproyecto",array("controller"=>"subproyectos","action"=>"confirmarAprobacion"));?>
<?php echo $this -> Form->input("verificacion",array("id"=>"inputVerificacion","label"=>false,"div"=>"verificacionInput"));?>
<?php echo $this -> Form->input("id",array("value"=>$subProyectoId,"label"=>false,"div"=>"verificacionInput"));?>
