...
<br />
<p>
	Por favor, digite el código de verificación y oprima el botón Reactivar Contrato.
</p>
<br />
<div class="verificacion"><?php echo $verificacion?></div>
<?php echo $this -> Form->create("Contrato",array("controller"=>"contratos","action"=>"confirmarReactivacion"));?>
...
<?php echo $this -> Form->end("Reactivar Contrato",array("class"=>"boton"));?>
<?php 
