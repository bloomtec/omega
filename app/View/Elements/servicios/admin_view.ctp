			...
			<table>
				...
				<tr>
					<td>
						...
						<div id="upload_control_ejecucion" path="/files" controller="proyectos"
						     action="AJAX_subirControlEjecucion"
						     model_id="<?php echo $proyecto['Proyecto']['id']; ?>"></div>
					</td>
				...
				<?php if(!empty($proyecto['Proyecto']['cronograma'])) : ?>
					<tr>
						<td>Cronograma</td>
						<td id="CronogramaView"><?php echo $this->Html->link($this->Html->image('/img/Calendario.png', array('title' => 'Ver Cronograma', 'alt' => 'Ver Cronograma', 'height' => '25')), array("controller" => "proyectos", "action" => "verCronograma", $proyecto['Proyecto']['id']), array('escape' => false)); ?></td>
					</tr>
				<?php endif; ?>
				<?php if(!empty($proyecto['Proyecto']['control_ejecucion'])) : ?>
					<tr id="ControlViewRow">
						<td>Control De Ejecución</td>
						<td id="ControlView"><?php echo $this->Html->link($this->Html->image('/img/Calendario.png', array('title' => 'Ver Control De Ejecución', 'alt' => 'Ver Cronograma', 'height' => '25')), array("controller" => "proyectos", "action" => "verControlEjecucion", $proyecto['Proyecto']['id']), array('escape' => false)); ?></td>
					</tr>
				<?php endif; ?>
				</tbody>
